...
private:
    ...
    void processTrackedPersonsMessage(const tracking_msgs::TrackedPersons::ConstPtr &msg);

    rviz::AdditionalTopicSubscriber<tracking_msgs::TrackedPersons> *m_tracked_person_subscriber;
