...
class TrackedPersonsDisplay : public PersonDisplayCommon<tracking_msgs::TrackedPersons>
{
    Q_OBJECT
public:
...
private:
    ...
    void processMessage(const tracking_msgs::TrackedPersons::ConstPtr &msg);
