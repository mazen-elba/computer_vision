...
#include <tracking_msgs/DetectedPersons.h>
...
class DetectedPersonsDisplay : public PersonDisplayCommon<tracking_msgs::DetectedPersons>
{
    Q_OBJECT
public:
...
private:
    ...
    void processMessage(const tracking_msgs::DetectedPersons::ConstPtr &msg);
