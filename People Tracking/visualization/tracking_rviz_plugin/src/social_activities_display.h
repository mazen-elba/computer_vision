...
#include <social_relation_msgs/SocialActivities.h>
#endif
...
class SocialActivitiesDisplay : public PersonDisplayCommon<social_relation_msgs::SocialActivities>
{
    Q_OBJECT
public:
...
private:
    ...
    void processMessage(const social_relation_msgs::SocialActivities::ConstPtr &msg);
