...
#ifndef Q_MOC_RUN
#include <social_relation_msgs/SocialRelations.h>
...
class SocialRelationsDisplay : public PersonDisplayCommon<social_relation_msgs::SocialRelations>
{
    Q_OBJECT
public:
...
private:
    ...
    void processMessage(const social_relation_msgs::SocialRelations::ConstPtr &msg);
