...
void Renderer::setup()
{
    ...
    m_tonemapProgram = linkProgram({compileShader("shaders/glsl/tonemap_vs.glsl", GL_VERTEX_SHADER),
                                    compileShader("shaders/glsl/tonemap_fs.glsl", GL_FRAGMENT_SHADER)});

    m_skybox = createMeshBuffer(Mesh::fromFile("meshes/skybox.obj"));
    m_skyboxProgram = linkProgram({compileShader("shaders/glsl/skybox_vs.glsl", GL_VERTEX_SHADER),
    ...
    m_pbrProgram = linkProgram({compileShader("shaders/glsl/pbr_vs.glsl", GL_VERTEX_SHADER),
