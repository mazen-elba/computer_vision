...
void DetectedPersonsDisplay::processMessage(const tracking_msgs::DetectedPersons::ConstPtr &msg)
{
    ...
    //
    for (vector<tracking_msgs::DetectedPerson>::const_iterator detectedPersonIt = msg->detections.begin(); detectedPersonIt != msg->detections.end(); ++detectedPersonIt)
    {
