# Head Pose Estimation using CNN
...
To reproduce the facial landmark detection model, the training code is open sourced: https://github.com/yinguobing/cnn-facial-landmark
