...
#include <human_attribute_msgs/HumanAttributes.h>
...
class HumanAttributesDisplay : public PersonDisplayCommon<human_attribute_msgs::HumanAttributes>
{
    Q_OBJECT
public:
...
private:
    ...
    void processMessage(const human_attribute_msgs::HumanAttributes::ConstPtr &msg);
