...
void SocialRelationsDisplay::processMessage(const social_relation_msgs::SocialRelations::ConstPtr &msg)
{
    ...
    foreach (const social_relation_msgs::SocialRelation &socialRelation, msg->elements)
    {
...
PLUGINLIB_EXPORT_CLASS(tracking_rviz_plugin::SocialRelationsDisplay, rviz::Display)
