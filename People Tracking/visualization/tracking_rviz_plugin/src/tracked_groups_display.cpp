...
void TrackedGroupsDisplay::processMessage(const tracking_msgs::TrackedGroups::ConstPtr &msg)
{
    ...
    //
    foreach (const tracking_msgs::TrackedGroup &trackedGroup, msg->groups)
    {
...
PLUGINLIB_EXPORT_CLASS(tracking_rviz_plugin::TrackedGroupsDisplay, rviz::Display)
