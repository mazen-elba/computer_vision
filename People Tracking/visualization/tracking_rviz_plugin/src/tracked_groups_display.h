...
#endif
#include <tracking_msgs/TrackedGroups.h>
...
class TrackedGroupsDisplay : public PersonDisplayCommon<tracking_msgs::TrackedGroups>
{
    Q_OBJECT
public:
...
private:
    ...
    void processMessage(const tracking_msgs::TrackedGroups::ConstPtr &msg);
